...
export default function HabitCard({ data }: { data: Array<object> }) {
  ...
  useEffect(() => {
    const sortedData = data.slice().reverse().slice(0, 7);
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>Principle of 100. Do it consistently for 100 days to become second nature.</CardDescription>
      </CardHeader>
        ...
        <div className='flex justify-center items-center gap-2 w-full h-full'>
          <ResponsiveContainer width="100%" height="100%">
            <BarChart data={chartData}>
              ...
              <YAxis tickCount={2} />
              <Tooltip />
              <Bar stackId='a' dataKey="dsa_y_n" name="Solve DSA" fill='#00AAFF' />
              <Bar stackId='a' dataKey="read_scriptures_y_n" name="Read Scriptures" fill='#FF3D7F' />
